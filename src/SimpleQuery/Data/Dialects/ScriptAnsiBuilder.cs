...
{
    public class ScriptAnsiBuilder:ScriptCommon, IScriptBuilder
    {
        public DbServerType DbServerType => DbServerType.Ansi;
        ...
        private string GetTypeAnsi(PropertyInfo item)
        {
